...
// up into AdminShell -- see AdminShell.tsx -- since the button now lives
// in the top bar, not inside AdminSidebar's own header row, so this is
// the right place for these tests now (moved from AdminSidebar.test.tsx).
...
describe('AdminShell collapse toggle (moved into the top bar, beside the heading)', () => {
